...
import { USER_TYPE_ADMIN, USER_TYPE_USER } from "./../constanse/constance";
import {
...
UserModal.propTypes = {
  ...
  deleteUserData: PropTypes.object,
...
const UserModalExport = compose(memo, withConnect)(UserModal);

export default UserModalExport;
