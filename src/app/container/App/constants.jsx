...
export const MENUSIDE_OPEN = 'app/App/MENUSIDE_OPEN';
export const CATEGORY_SID_OPEN = 'app/App/CATEGORY_SID_OPEN';

export const NOTIFICATION_SHOW = 'app/App/NOTIFICATION_SHOW';
export const NOTIFICATION_TYPE_SUCCESS = 'app/App/NOTIFICATION_TYPE_SUCCESS';
...
export const ISADMIN_USER = 'app/App/ISADMIN_USER';
export const ISADMIN_USER_SUCCESS = 'app/App/ISADMIN_USER_SUCCESS';
export const ISADMIN_USER_FAIL = 'app/App/ISADMIN_USER_FAIL';


export const LOGIN_USER = 'app/App/LOGIN_USER';
export const LOGIN_USER_SUCCESS = 'app/App/LOGIN_USER_SUCCESS';
export const LOGIN_USER_FAIL = 'app/App/LOGIN_USER_FAIL';

export const ADD_TO_CART = 'app/App/ADD_TO_CART';
export const REMOVE_CART = 'app/App/REMOVE_CART';
export const DELETE_CART = 'app/App/DELETE_CART';
export const DELETE_CART_ALL = 'app/App/DELETE_CART_ALL';
export const SHOWE_CART = 'app/App/SHOWE_CART';
